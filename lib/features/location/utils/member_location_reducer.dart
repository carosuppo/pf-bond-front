...
Map<int, MemberLocationModel> reduceMemberLocations(
  ...
  if (event is MemberLocationHeartbeat && event.groupId == activeGroupId) {
    final member = current[event.memberId];
    ...
    return <int, MemberLocationModel>{
      ...
      event.memberId: member.copyWith(lastSeenAt: event.lastSeenAt),
    };
  }
